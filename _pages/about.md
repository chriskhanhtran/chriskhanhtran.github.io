...
[Curriculum Vitae](https://chriskhanhtran.github.io/about/){: .btn .btn--info} [Portfolio](https://chriskhanhtran.github.io/portfolio/){: .btn .btn--info} [LinkedIn](https://www.linkedin.com/in/chriskhanhtran/){: .btn .btn--info}
{: .text-center}

## Career Objectives
My name is Chris Tran. I am a **Machine Learning Research Intern** at **Skim AI Technologies**, where I applies latest research in Deep Learning NLP to make machines understand human languages better. Projects I am working on include Document Classification, Language Generation, Summarization and Named-entity Recognition (NER). My research interests are in transfer learning, where deep neural networks which were pretrained on large corpora to "understand" our languagues can be fine-tuned for different tasks on much smaller datasets to receive near state-of-the-art results.
